...
Builds the [blacklabelops/centosfirewall](https://atlas.hashicorp.com/blacklabelops/boxes/centosfirewall) Image on Atlas. This is a Vagrant box, never use it for production!

Features:

* Tested On: Packer, Vagrant, Virtualbox
* Includes: CentOS 7 minimal, latest kernel, firewall enabled!
